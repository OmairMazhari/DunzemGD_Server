...
class WeaponResource : public ResourceState {
    GDCLASS(WeaponResource, ResourceState);
public:
    WeaponResource();
    ~WeaponResource();

    // Override functions
    void Setup(ResourceFSM* owner) override;
    void Enter() override;
...
public:
    ...
    void set_input(Dictionary p_val) { input = p_val; }
    Dictionary get_input() { return input; }
